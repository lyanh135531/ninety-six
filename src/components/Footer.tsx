    ...
    <footer className="mt-0 border-t border-gray-100" style={{ background: "linear-gradient(180deg, #f8fafc 0%, #ffffff 100%)" }}>
      ...
      <div className="container mx-auto px-6 max-w-7xl py-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="space-y-5 lg:col-span-1">
          ...
          <p className="text-teal-800/60 text-sm leading-relaxed max-w-xs">
            Chuyên cung cấp quần áo ngủ, đồ bộ dạo mặc nhà cao cấp dành cho <strong className="text-teal-800 font-semibold">Mẹ và Bé</strong>. Mềm mại nâng niu những giấc ngủ êm đềm.
          </p>
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              aria-label="Facebook"
              className="w-9 h-9 rounded-xl flex items-center justify-center bg-white border border-gray-200 text-teal-800/60 hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all duration-200 shadow-sm hover:shadow-md hover:-translate-y-0.5"
            >
            ...
            <a
              ...
              className="w-9 h-9 rounded-xl flex items-center justify-center bg-white border border-gray-200 text-teal-800/60 hover:bg-gradient-to-br hover:from-pink-500 hover:to-orange-400 hover:text-white hover:border-pink-500 transition-all duration-200 shadow-sm hover:shadow-md hover:-translate-y-0.5"
            >
              <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
            ...
            <a
              ...
              rel="noopener noreferrer"
              aria-label="TikTok"
              className="w-9 h-9 rounded-xl flex items-center justify-center bg-white border border-gray-200 text-teal-800/60 hover:bg-gray-900 hover:text-white hover:border-gray-900 transition-all duration-200 shadow-sm hover:shadow-md hover:-translate-y-0.5"
            >
              <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
        ...
        {/* Chính sách */}
        <div>
          <h3 className="text-xs font-black text-teal-900 uppercase tracking-[0.18em] mb-5">Chính Sách</h3>
          <ul className="space-y-3">
            {POLICY_LINKS.map(({ href, label }) => (
              <li key={href}>
                <Link
                  href={href}
                  className="text-sm text-teal-800/60 hover:text-teal-900 transition-colors flex items-center gap-1.5 group/link"
                >
        ...
        {/* Hỗ trợ */}
        <div>
          <h3 className="text-xs font-black text-teal-900 uppercase tracking-[0.18em] mb-5">Hỗ Trợ Khách Hàng</h3>
          <ul className="space-y-3">
        ...
        {/* Liên hệ */}
        <div>
          <h3 className="text-xs font-black text-teal-900 uppercase tracking-[0.18em] mb-5">Liên Hệ</h3>
          <ul className="space-y-4">
            <li>
              <a href="tel:19001234" className="flex items-start gap-3 text-sm text-teal-800/60 hover:text-teal-900 transition-colors group/item">
                ...
                <div>
                  <p className="font-semibold text-teal-800">Hotline</p>
                  <p className="text-xs mt-0.5">1900 1234 (8:00 – 22:00)</p>
                </div>
              </a>
            </li>
            <li>
              <a href="mailto:hello@ninetysix.vn" className="flex items-start gap-3 text-sm text-teal-800/60 hover:text-teal-900 transition-colors group/item">
                <div className="w-7 h-7 rounded-lg bg-teal-50 flex items-center justify-center shrink-0 mt-0.5 group-hover/item:bg-teal-100 transition-colors">
            ...
            <li>
              <div className="flex items-start gap-3 text-sm text-teal-800/60">
                ...
                <div>
                  <p className="font-semibold text-teal-800">Cửa hàng</p>
      ...
      <div className="border-t border-gray-100">
        <div className="container mx-auto px-6 max-w-7xl py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-teal-800/40 text-center sm:text-left">
            &copy; {year} <span className="font-semibold text-teal-800">Ninety Six Store</span>. Đã đăng ký bản quyền.
          </p>
          {/* Payment badges */}
          <div className="flex items-center gap-2">
            {["COD", "ATM", "Momo"].map(m => (
              <span key={m} className="px-2.5 py-1 bg-gray-100 text-teal-800/60 text-[10px] font-bold rounded-md border border-gray-200">
                {m}
              </span>
            ))}
          </div>
