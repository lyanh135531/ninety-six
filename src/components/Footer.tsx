      ...
      <div className="container mx-auto px-6 max-w-7xl py-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="space-y-5 lg:col-span-1">
          <Link href="/" className="inline-flex items-center gap-3 group" aria-label="Trang chủ Ninety Six">
            ...
            <div>
              <p className="font-black text-gray-900 text-sm tracking-tight leading-none">NINETY SIX</p>
              <p className="text-[9px] font-bold text-teal-600 tracking-[0.22em] uppercase mt-0.5">Mom &amp; Baby</p>
            </div>
          </Link>
          ...
          <ul className="space-y-3">
            {POLICY_LINKS.map(({ href, label }) => (
              <li key={href}>
                <Link
                  href={href}
                  className="text-sm text-gray-500 hover:text-teal-700 transition-colors flex items-center gap-1.5 group/link"
                >
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li>
              <a href="tel:19001234" className="flex items-start gap-3 text-sm text-gray-500 hover:text-teal-700 transition-colors group/item">
            ...
            <li>
              <a href="mailto:hello@ninetysix.vn" className="flex items-start gap-3 text-sm text-gray-500 hover:text-teal-700 transition-colors group/item">
                <div className="w-7 h-7 rounded-lg bg-teal-50 flex items-center justify-center shrink-0 mt-0.5 group-hover/item:bg-teal-100 transition-colors">
