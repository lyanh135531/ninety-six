...
export default async function NewProductPage() {
  ...
  return (
    <div className="p-8">
      <Link href="/admin/products" className="inline-flex items-center gap-2 text-teal-800/60 hover:text-teal-900 mb-6 font-medium transition">
        <ChevronLeft className="w-5 h-5" />
        Quay Lại Danh Sách
      </Link>
      <h1 className="text-3xl font-bold text-teal-900 mb-8">Thêm Sản phẩm mới</h1>
