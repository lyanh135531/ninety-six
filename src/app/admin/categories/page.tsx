        ...
        <div className="xl:col-span-4">
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 h-fit sticky top-24 transition-all hover:shadow-xl hover:shadow-teal-900/[0.02]">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-10 h-10 bg-teal-50 text-teal-900 rounded-xl flex items-center justify-center shadow-inner">
              ...
              >
                ...
                <div className="relative z-10 h-full flex flex-col">
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <div className="w-11 h-11 bg-teal-50 text-teal-900 rounded-xl flex items-center justify-center group-hover:rotate-6 transition-transform shadow-inner">
