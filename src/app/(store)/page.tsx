...
const COMMITMENTS = [
  {
    ...
    desc: "Toàn quốc, không giới hạn đơn",
    color: "teal",
  },
  {
    icon: RefreshCw,
    title: "Đổi trả trong 7 ngày",
    desc: "Dễ dàng, không phức tạp",
    color: "blue",
  },
  {
    icon: Leaf,
    title: "100% Vải hữu cơ",
    desc: "An toàn cho mẹ và làn da bé",
    color: "emerald",
  },
  {
    icon: ShieldCheck,
    title: "Bảo hành chất lượng",
    desc: "Cam kết từ nhà sản xuất",
    color: "violet",
  },
];
...
export default async function StorefrontHome({
  ...
  const [heroProductRaw, featuredProductsRaw, allLatestProductsRaw] =
    await Promise.all([
  ...
  >(p: T): T & { stockBySizes: string; sizes: string | null | undefined };
  ...
  >(
    p: T | null,
  ): (T & { stockBySizes: string; sizes: string | null | undefined }) | null;
  function mergeExtras<
    T extends {
      id: string;
      stockBySizes?: string | null;
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, #f0fdf9 0%, #ffffff 45%, #fff1f2 100%)",
        }}
      >
        {/* Background blobs */}
        <div
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(244,63,94,0.09) 0%, transparent 70%)",
          }}
        />
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse, rgba(20,184,166,0.06) 0%, transparent 65%)",
          }}
        />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="space-y-7 text-center md:text-left">
              ...
              <div className="space-y-3">
                <h1 className="text-4xl lg:text-[56px] font-black text-teal-900 leading-[1.1] tracking-tight">
                  Ngủ Êm Đềm <br />
                  <span className="relative z-10" style={{ color: "#0f766e" }}>
                    Đẹp Rạng Ngời
                  </span>
                </h1>
                <p className="text-base lg:text-lg text-teal-800/60 max-w-md mx-auto md:mx-0 leading-relaxed">
                  ...
                  <strong className="text-teal-800">Mẹ và Bé</strong>. Lụa satin
                  &amp; cotton organic mềm mại — mang lại giấc ngủ trọn vẹn
                  nhất.
                </p>
              </div>
            ...
            <div className="flex justify-center md:justify-end">
              <div className="relative">
                {/* Main card */}
                <div
                  className="w-64 h-[340px] md:w-80 md:h-[430px] lg:w-96 lg:h-[520px] rounded-[2.5rem] overflow-hidden relative border-4 border-white shadow-2xl"
                  style={{
                    boxShadow: "0 32px 64px rgba(0,0,0,0.12), 0 0 0 4px white",
                  }}
                >
                ...
                {heroProduct && (
                  ...
                  >
                    <p className="text-[10px] text-teal-800/40 font-semibold uppercase tracking-wider">
                      Giá từ
                    </p>
                ...
                <div className="animate-float-rev absolute top-8 -left-10 bg-white rounded-2xl shadow-md px-3.5 py-2.5 border border-gray-100 hidden lg:flex items-center gap-2">
                  <div className="w-7 h-7 rounded-lg bg-teal-50 flex items-center justify-center text-teal-600">
                    <Leaf className="w-4 h-4" />
                  </div>
                  <div>
                    <p className="text-[10px] font-black text-teal-800 leading-none">
                      Cotton Hữu Cơ
                    </p>
                    <p className="text-[9px] text-teal-800/40 mt-0.5">
                      Chứng nhận GOTS
                    </p>
                  </div>
                </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 h-8 pointer-events-none">
          ...
          >
            <path
              d="M0 32L1440 32L1440 0C1200 28 900 32 720 20C540 8 240 0 0 20L0 32Z"
              fill="white"
            />
          </svg>
        </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-0 divide-x divide-y lg:divide-y-0 divide-gray-100">
            {COMMITMENTS.map(({ icon: Icon, title, desc, color }) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-10 h-10 rounded-2xl ${cls.bg} flex items-center justify-center shrink-0 transition-transform group-hover:scale-110 group-hover:rotate-3 duration-300`}
                  >
                    <Icon className={`w-4.5 h-4.5 ${cls.icon}`} />
                  </div>
                  <div>
                    <p className="font-bold text-teal-900 text-sm leading-tight">
                      {title}
                    </p>
                    <p className="text-xs text-teal-800/40 mt-0.5 leading-snug">
                      {desc}
                    </p>
                  </div>
                </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-12">
            <p className="text-xs font-black text-teal-600 uppercase tracking-[0.25em] mb-3">
              Bộ sưu tập
            </p>
            <h2 className="text-3xl md:text-4xl font-black text-teal-900">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 lg:gap-7">
            ...
            >
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #0f766e 0%, #0c4a6e 100%)",
                }}
              />
              {/* Decorative circles */}
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-8">
                <span className="text-teal-300 text-[10px] font-black uppercase tracking-[0.25em] mb-2">
                  Bộ sưu tập
                </span>
                <h3 className="text-3xl md:text-4xl font-black text-white mb-2 group-hover:text-teal-100 transition-colors">
                  Đồ Ngủ Cho Mẹ
                </h3>
                <p className="text-teal-200 text-sm mb-5 max-w-xs leading-relaxed">
                  Lụa satin, cotton organic — Sang trọng &amp; thoải mái tuyệt
                  đối
                </p>
            ...
            <div className="flex items-end justify-between mb-12">
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-xs font-black text-teal-600 uppercase tracking-[0.22em]">
                    Lựa chọn hàng đầu
                  </p>
                </div>
                <h2 className="text-3xl md:text-4xl font-black text-teal-900">
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="flex items-end justify-between mb-12">
            <div className="space-y-2">
              {query ? (
                <>
                  <p className="text-xs font-black text-teal-800/40 uppercase tracking-[0.22em]">
                    Kết quả tìm kiếm
                  </p>
                ...
                <>
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-xs font-black text-pink-500 uppercase tracking-[0.22em]">
                      Mới lên kệ
                    </p>
                  </div>
                  <h2 className="text-3xl md:text-4xl font-black text-teal-900">
          ...
          {allLatestProducts.length > 0 ? (
            ...
            <div className="py-24 flex flex-col items-center justify-center text-center space-y-4 bg-gray-50/60 rounded-3xl border-2 border-dashed border-gray-200">
              ...
              <p className="text-teal-800/40 text-sm max-w-xs">
                Hãy thử tìm với từ khóa khác. Chúng tôi có hàng trăm sản phẩm
                đang chờ bạn!
              </p>
              <Link
                href="/"
      ...
      >
        <div className="container mx-auto px-6 max-w-7xl text-center text-white">
          <p className="text-teal-300 text-xs font-black uppercase tracking-[0.25em] mb-4">
            Tại sao chọn chúng tôi?
          </p>
          <h2 className="text-2xl md:text-3xl font-black mb-4">
            Được Hàng Nghìn Mẹ Yêu Thích
          </h2>
          <p className="text-teal-100 text-sm md:text-base max-w-lg mx-auto leading-relaxed mb-10">
            Mỗi sản phẩm đều trải qua kiểm định chất lượng nghiêm ngặt. Chúng
            tôi tin rằng giấc ngủ ngon bắt đầu từ bộ đồ ngủ hoàn hảo.
          </p>
          <div className="flex flex-wrap justify-center gap-8">
            {[
              ...
              <div
                key={label}
                className="flex items-center gap-2.5 bg-white/15 rounded-full px-5 py-2.5"
              >
                <span>{icon}</span>
