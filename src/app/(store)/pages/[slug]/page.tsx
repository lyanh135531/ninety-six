...
const POLICY_DATA: Record<string, PolicyItem> = {
    ...
    content: (
      <div className="space-y-8">
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc list-inside space-y-2 text-teal-800 ml-2">
        ...
        <section className="space-y-4">
          ...
          <p className="text-teal-800 leading-relaxed font-bold text-teal-900">
  ...
  "size-guide": {
    ...
    content: (
      <div className="space-y-8">
        <section className="space-y-4">
          <h2 className="text-xl font-bold text-teal-900 font-bold border-b border-gray-100 pb-2">Bảng Size Cho Mẹ</h2>
          <table className="w-full border-collapse rounded-xl overflow-hidden shadow-sm text-left">
            ...
            <tbody className="text-sm text-teal-800">
      ...
      <div className="space-y-4">
        {[
          ...
          <div key={i} className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow group">
            ...
            <p className="text-teal-800 text-sm pl-9 leading-relaxed">{item.a}</p>
          </div>
        ))}
      </div>
    )
    ...
    <div className="min-h-screen bg-gray-50/50 pb-20">
      ...
      <section className="bg-white border-b border-gray-100 py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <nav className="flex items-center justify-center gap-2 text-xs font-black text-teal-800/30 uppercase tracking-widest mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-teal-900 mb-4">{page.title}</h1>
          <p className="text-teal-800/60 text-lg max-w-xl mx-auto">{page.description}</p>
        </div>
      </section>
          ...
          <div className="mt-16 pt-10 border-t border-gray-100 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              ...
              <div className="text-left">
                <p className="text-sm font-bold text-teal-900">Vẫn còn thắc mắc?</p>
                <p className="text-xs text-teal-800/60">Chúng tôi luôn sẵn sàng hỗ trợ bạn.</p>
              </div>
            </div>
